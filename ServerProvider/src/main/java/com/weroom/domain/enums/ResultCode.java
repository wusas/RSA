package com.weroom.domain.enums;

import com.weroom.domain.IErrorCode;
...
public enum ResultCode implements IErrorCode {
    ...
    INPUT_ERROR_INPUT(90006, "输入错误，请重新输入"),
    INPUT_ERROR_FIND_PASSWORD(90007, "输入错误，请使用找回支付密码功能"),
    TWO_INPUT_ERROR_SET_PASSWORD(90008, "2次输入的密码不一致，请重新输入"),
    ;
    private long code;
